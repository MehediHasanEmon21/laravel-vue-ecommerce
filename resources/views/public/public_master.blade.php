...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/public') }}//assets/public/img/favicon.ico">

    <link rel="apple-touch-icon" href="{{ asset('assets/public') }}/apple-touch-icon.png">
